...
4. `scripts/seed/seed-prisma.ts` reads `DATABASE_URL` and `DIRECT_URL`; `scripts/seed/seed-qdrant.ts` reads `QDRANT_URL`, `QDRANT_API_KEY`, and optional `QDRANT_COLLECTION`.
